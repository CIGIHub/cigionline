    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('search_terms', wagtail.core.fields.StreamField([('search_term', wagtail.core.blocks.CharBlock())], blank=True, help_text='A list of search terms for which this page will be elevated in the search results.')),
                ('external_authors', wagtail.core.fields.StreamField([('external_person', streams.blocks.ExternalPersonBlock())], blank=True)),
                ('external_editors', wagtail.core.fields.StreamField([('external_person', streams.blocks.ExternalPersonBlock())])),
