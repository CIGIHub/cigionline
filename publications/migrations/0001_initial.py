# Generated by Django 3.0.6 on 2020-05-19 18:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_format', models.CharField(blank=True, choices=[('HC', 'Hardcover'), ('PB', 'Paperback'), ('TP', 'Trade PB')], help_text='Select the formation of this book/publication.', max_length=2, null=True, verbose_name='Format')),
                ...
                ('editors', wagtail.core.fields.StreamField([('editor', wagtail.core.blocks.PageChooserBlock(page_type=['people.PersonPage'], required=True)), ('external_editor', wagtail.core.blocks.CharBlock(required=True))])),
