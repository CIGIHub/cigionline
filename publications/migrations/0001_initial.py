    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editors', wagtail.core.fields.StreamField([('editor', streams.blocks.EditorBlock(page_type=['people.PersonPage'], required=True)), ('external_editor', wagtail.core.blocks.CharBlock(required=True))], blank=True)),
