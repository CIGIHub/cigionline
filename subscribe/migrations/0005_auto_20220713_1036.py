...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('subscribe', '0004_use_custom_image_model'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='subscribepage',
            name='landing_page_body',
            field=wagtail.fields.StreamField([('paragraph', streams.blocks.ParagraphBlock())], blank=True, help_text='The contents of this stream field will be displayed after sign up.', use_json_field=True),
        ),
    ]
