...
const ContentSlide = ({ slide, contentOpacity }) => {
  function contentLinkIcon(linkType) {
    if (linkType === 'PUBLICATION') {
      return (
        <svg
          ...
          data-icon="file-alt"
          data-prefix="fal"
          className="svg-inline--fa fa-file-alt fa-w-12 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-icon="film"
          data-prefix="fal"
          className="svg-inline--fa fa-film fa-w-16 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-prefix="fal"
          className="svg-inline--fa fa-comment-alt-lines fa-w-16 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-icon="newspaper"
          data-prefix="fal"
          className="svg-inline--fa fa-newspaper fa-w-18 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-icon="volume-up"
          data-prefix="fal"
          className="svg-inline--fa fa-volume-up fa-w-18 fa-lg"
        >
          <path
            fill="currentColor"
    ...
    } if (linkType.toUpperCase() === 'EXPERTS') {
      return (
        <svg
          viewBox="0 0 512 512"
          xmlns="http://www.w3.org/2000/svg"
          ...
          data-prefix="fal"
          className="svg-inline--fa fa-comment-dots fa-w-16 fa-lg"
        >
          <path
            fill="currentColor"
      ...
      return (
        <svg
          ...
          data-icon="envelope"
          data-prefix="fal"
          className="svg-inline--fa fa-envelope fa-w-16 fa-lg"
        >
          <path
            fill="currentColor"
