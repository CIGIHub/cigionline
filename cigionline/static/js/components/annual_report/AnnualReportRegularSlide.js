  ...
  research: (
    ...
    >
      ...
      <g
        ...
        fillRule="evenodd"
      >
        <g id="-copy" transform="translate(0, 0.875)" fillRule="nonzero">
          <path
  ...
  t7: (
    ...
    >
      ...
      <g
        ...
        fillRule="evenodd"
      >
        <g id="t" transform="translate(-106, -55)" fillRule="nonzero">
          <path
  ...
  website: (
    ...
    >
      ...
      <g
        ...
        fillRule="evenodd"
      >
        <g id="globe" transform="translate(-0, 0.875)" fillRule="nonzero">
          <path
                          ...
                          >
                            ...
                            <div className="content-copy">
                              {contentBlock.type_override ? (
                                <h4>
                                  {lang === 'fr'
                                    ? contentBlock.type_override_fr
                                    : contentBlock.type_override}
                                </h4>
                              ) : (
                                <h4>
                                  {lang === 'fr'
                                    ? contentBlock.type_fr
                                    : contentBlock.type}
                                </h4>
                              )}
                              <p>
