...
if 'MAILCHIMP_DEFAULT_TAG' in os.environ:
    MAILCHIMP_DEFAULT_TAG = os.environ['MAILCHIMP_DEFAULT_TAG']
...
if 'SENDGRID_FROM_EMAIL_RENTALS' in os.environ:
    SENDGRID_FROM_EMAIL_RENTALS = os.environ['SENDGRID_FROM_EMAIL_RENTALS']

if 'DOCUMENT_UPLOAD_PASSWORD' in os.environ:
    DOCUMENT_UPLOAD_PASSWORD = os.environ['DOCUMENT_UPLOAD_PASSWORD']

if 'SENDGRID_FROM_EMAIL_EVENTS' in os.environ:
    SENDGRID_FROM_EMAIL_EVENTS = os.environ['SENDGRID_FROM_EMAIL_EVENTS']
if 'SENDGRID_FROM_NAME_EVENTS' in os.environ:
    SENDGRID_FROM_NAME_EVENTS = os.environ['SENDGRID_FROM_NAME_EVENTS']
