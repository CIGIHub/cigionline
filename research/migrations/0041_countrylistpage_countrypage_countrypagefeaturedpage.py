# Generated by Django 3.2.18 on 2024-07-02 20:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(blank=True, help_text='Override political name with common name for tag display.', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='CountryPageFeaturedPage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('country_page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='featured_pages', to='research.countrypage')),
