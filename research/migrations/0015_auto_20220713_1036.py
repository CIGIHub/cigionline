...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('research', '0014_increase_feature_subtitle_length'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=wagtail.fields.StreamField([('contact', wagtail.blocks.PageChooserBlock(page_type=['people.PersonPage'], required=True))], blank=True, use_json_field=True),
        ),
        migrations.AlterField(
            model_name='projectpage',
            name='project_leads',
            field=wagtail.fields.StreamField([('project_lead', wagtail.blocks.PageChooserBlock(page_type=['people.PersonPage'], required=True)), ('external_project_lead', wagtail.blocks.CharBlock(required=True))], blank=True, use_json_field=True),
        ),
        migrations.AlterField(
            model_name='projectpage',
            name='project_members',
            field=wagtail.fields.StreamField([('project_member', wagtail.blocks.PageChooserBlock(page_type=['people.PersonPage'], required=True)), ('external_project_member', wagtail.blocks.CharBlock(required=True))], blank=True, use_json_field=True),
        ),
        migrations.AlterField(
            model_name='projectpage',
            name='related_files',
