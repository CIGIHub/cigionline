# Generated by Django 3.2.18 on 2024-05-08 19:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='primary_theme',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='research.themepage', verbose_name='Primary Theme'),
        ),
        migrations.AddField(
            model_name='projectpage',
            name='secondary_themes',
            field=modelcluster.fields.ParentalManyToManyField(blank=True, to='research.ThemePage'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['archive'], name='research_th_archive_80c868_idx'),
        ),
    ]
