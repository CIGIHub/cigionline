    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_the_archives', models.BooleanField(default=False, help_text='When enabled, show the "From the Archives" label if content is featured on front page.', verbose_name='From the Archives')),
                ('from_the_archives_blurb', wagtail.core.fields.RichTextField(blank=True, help_text='Block displayed on page.', verbose_name='From the Archives Blurb')),
                ('credits', wagtail.core.fields.RichTextField(blank=True)),
                ('credits_artwork', models.CharField(blank=True, max_length=255)),
                ('featured_items', wagtail.core.fields.StreamField([('featured_item', wagtail.core.blocks.PageChooserBlock(page_type=['articles.ArticlePage', 'multimedia.MultimediaPage'], required=True))], blank=True)),
                ('series_items', wagtail.core.fields.StreamField([('series_item', wagtail.core.blocks.PageChooserBlock(page_type=['articles.ArticlePage', 'multimedia.MultimediaPage'], required=True)), ('category_title', wagtail.core.blocks.CharBlock(required=True))], blank=True)),
                ('short_description', wagtail.core.fields.RichTextField(blank=True)),
                ('drupal_node_id', models.IntegerField(blank=True, null=True)),
            ],
            options={
