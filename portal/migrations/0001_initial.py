# Generated by Django 5.0.6 on 2025-04-22 14:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resources', wagtail.fields.StreamField([('resource', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(required=False)), ('description', wagtail.blocks.RichTextBlock(required=False)), ('file', wagtail.documents.blocks.DocumentChooserBlock(required=False)), ('cta_link', wagtail.blocks.URLBlock(required=False)), ('cta_text', wagtail.blocks.CharBlock(required=False)), ('image', wagtail.images.blocks.ImageChooserBlock(required=False))]))], blank=True)),
